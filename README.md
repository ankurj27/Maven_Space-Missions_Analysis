...
Provided by Maven Analytics as part of the Maven Return to Space Challenge.
...
Explore the visuals, filters, and measures.

Review the DAX code in the Model View.

🙌 Acknowledgments

Thanks to Maven Analytics for hosting this challenge and providing an opportunity to apply analytics, storytelling, and dashboard design to real-world space data.
